...
class SimpleArithmeticListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpleArithmeticParser#start.
    def enterStart(self, ctx:SimpleArithmeticParser.StartContext):
        pass

    # Exit a parse tree produced by SimpleArithmeticParser#start.
    def exitStart(self, ctx:SimpleArithmeticParser.StartContext):
        pass
